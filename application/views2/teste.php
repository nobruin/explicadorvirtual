...
<html lang="en">
    <head>
        ...
        <!--<link href="css/colour-red.css" rel="stylesheet">-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-xs-pull-8">
                                ...
                                <div class="btn-group user-menu">
                                    ...
                                    <a href="#signup-modal" class="btn btn-link signup" data-toggle="modal">Registre-se</a>
                                    </li>
                        ...
                        <div class="navbar">
                            <div class="pull-left">
                                ...
                                <a class="navbar-brand" href="index.htm" title="Home">
                                    <h1>
                                       <img src="{url}img/logo_explicador.png" alt="Logotipo" />
                                    </h1>
                                </a>
                            </div>
                            ...
                            <div class="navbar-collapse collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="home-link">
                                        <a href="index.htm"><i class="fa fa-home"></i><span class="hidden">Início</span></a>
                                    </li>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="pages-drop">
                                            <li><a href="customers.htm" class="menu-item">Quem Somos</a></li>
                                            <li><a href="features.htm" class="menu-item">Missão</a></li>
                                            <li role="presentation"><a role="menuitem" href="login.htm" tabindex="-1" class="menu-item">Visão</a></li>
                                            <li role="presentation"><a role="menuitem" href="signup.htm" tabindex="-1" class="menu-item">Valores</a></li>
                                            <li role="presentation"><a role="menuitem" href="starter.htm" tabindex="-1" class="menu-item">Objetivos</a></li>
                                        </ul>
                                    </li>
                                                ...
                                                <ul class="row list-unstyled" role="menu">
                                                    <li class="col-md-3" role="presentation">
                                                        <a role="menuitem" href="features.htm" class="img-link">
                                                            <img src="img/features/feature-1.png" alt="Curso 6º Ano" />
                                                        </a>
                                                        <a role="menuitem" href="features.htm" tabindex="-1" class="menu-item"><strong>6º ano</strong></a>
                                                        <span>Aulas de alta qualidade ministradas por professores especialistas em seus assuntos.</span> 
                                                    </li>
                                                    <li class="col-md-3" role="presentation">
                                                        <a role="menuitem" href="features.htm" class="img-link">
                                                            <img src="img/features/feature-2.png" alt="Curso 7º ano" />
                                                        </a>
                                                        <a role="menuitem" href="features.htm" tabindex="-1" class="menu-item"><strong>7º ano</strong></a>
                                                        <span>Aulas de alta qualidade ministradas por professores especialistas em seus assuntos.</span> 
                                                    </li>
                                                    <li class="col-md-3" role="presentation">
                                                        <a role="menuitem" href="features.htm" class="img-link">
                                                            <img src="img/features/feature-3.png" alt="Curso 8º Ano" />
                                                        </a>
                                                    ...
                                                    <li class="col-md-3" role="presentation">
                                                        <a role="menuitem" href="features.htm" class="img-link">
                                                            <img src="img/features/feature-4.png" alt="Curso 9º ano" />
                                                        </a>
                                    ...
                                    <li class="dropdown active">
                                        <a href="#sad" class="dropdown-toggle">Professores</a> 
                                    </li>
                                </ul>
                            </div>
                            <!--/.navbar-collapse -->
                    ...
                    <div class="menu_lateral">
                      <h4>CURSOS</h4>
                        <ul class="nav nav-pills nav-stacked">
                            <li role="presentation" class="active"><a href="#">CADASTRAR AULAS</a></li>
                            <li role="presentation"><a href="#">NOME DO ITEM</a></li>
                            <li role="presentation"><a href="#">NOME DO ITEM</a></li>
                            <li role="presentation"><a href="#">NOME DO ITEM</a></li>
                            <li role="presentation"><a href="#">NOME DO ITEM</a></li>
                            <li role="presentation"><a href="#">NOME DO ITEM</a></li>
                      ...
                      <h4 class="margin_top_40">CLIENTES</h4>
                        <ul class="nav nav-pills nav-stacked">
                            <li role="presentation"><a href="#">NOME DO ITEM</a></li>
                            <li role="presentation"><a href="#">NOME DO ITEM</a></li>
                            <li role="presentation"><a href="#">NOME DO ITEM</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nome_aula" class="form-control">
                            </div>
                            <div class="form-group">
                            <div class="row">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-4">
                                    <label for="materia">PROFESSOR</label>
                                    <select id="materia" class="form-control">
                                        <option>Selecione</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="nome_aula">VIMEO EMBED URL</label>
                                <input type="text" id="nome_aula" class="form-control">
                            </div>
