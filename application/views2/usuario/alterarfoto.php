...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function ()
            {
                ...
                $('#divCampoUpload').mouseover(function ()
                {
                    $(this).css('background-image', "url('http://www.corretorvip.com.br/img/bt_inf_limpo_over.png')");
                    $(this).css('cursor', 'pointer');
                });
                $('#divCampoUpload').mouseout(function ()
                {
                    $(this).css('background-image', "url('http://www.corretorvip.com.br/img/bt_inf_limpo.png')");
    ...
    <body>
        <div style="margin:10px;">
            <div class="btn btn-success" style="position:absolute;left:10px;display:inline-block;width:170px">{rotBtAddFoto}:</div>
        ...
        <!--		<input type="button" class="bt_azul_geral" value="{rotBtAddFoto}" id="botaoDefinirFoto" /> -->
                        <div style="cursor:pointer;position:absolute;color:#ffffff;font-family:'Trebuchet MS';font-size:10pt;width:133px;height:35px;text-align:center;padding-top:8px;" id="divBtEscolherFoto">Escolher Foto</div>
            ...
            <div id="divFormRedimencionarFoto">
                <form id="formFinalizarFotoCorretor" action="{url}usuario/alterar_foto_fim" method="post" enctype="multipart/form-data" target="controleUploadFoto">
                    <input type="hidden" name="usuario_id" value="{usuario_id}" />
