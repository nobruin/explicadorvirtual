<div class="col-sm-9 col-md-9 col-lg-9"> <!-- CONTEUDO DA DIREITA -->
    ...
    <div class="painel_conteudo">
        ...
        <form action="{url}usuarios/alterar" role="form" method="post">
            ...
            <div class="form-group" >
                <img border="0" title="Clique para alterar a foto" src="{foto}" width="90" height="90" class="ui-corner-slider" style="border-radius:20px;cursor:pointer;" onclick="openWinFoto()"/>
            </div>
